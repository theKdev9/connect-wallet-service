...
var OkxConnect = /** @class */ (function (_super) {
    ...
    OkxConnect.prototype.ethRequestAccounts = function () {
        return this.connector.request({ method: "eth_requestAccounts" });
    };
    OkxConnect.prototype.getChainId = function () {
        return this.connector.request({ method: "eth_chainId" });
    };
    OkxConnect.prototype.checkNet = function () {
    ...
    OkxConnect.prototype.eventSubscriber = function () {
        var _this = this;
     ...
     */
    OkxConnect.prototype.getAccounts = function () {
        var _this = this;
        var error = {
            code: 3,
            message: {
